...
public class MainMenu : MonoBehaviour
{
    ...
    private void AttemptQuickLogin()
    {
        ...
        this._appleAuthManager.QuickLogin(
            ...
            credential =>
            {
                ...
                this.AuthenticateWithBrainCloud(credential.User, appleIdCredential.IdentityToken.ToString());
            },
            error =>
            {
    ...
    private void AuthenticateWithBrainCloud(string appleUserId, string identityToken)
    {
        bool forceCreate = true;
        Network.instance.RequestAppleAuthenticaion(appleUserId, identityToken, forceCreate, OnBrainCloudSuccess, OnBrainCloudFailure);
    }

    private void OnBrainCloudSuccess()
    {
        Debug.Log("BrainCloud Authentication success: ");
    }

    private void OnBrainCloudFailure()
    {
        Debug.LogWarning("BrainCloud authentication failed: ");
    }
}
